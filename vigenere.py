...
Note:
  ...
  3. The case of the key doesn't matter.
...
By default, vigenere assumes that the original plaintext message was written
...
Currently, vigenere's language options other than English are DE (German),
